...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kamvara — Clean Plant Protein, Nourished By Nature" },
      { property: "og:description", content: "Premium plant-based protein crafted with clean ingredients. 24g protein, zero artificial flavours. Nothing artificial. Nothing hidden." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Kamvara — Clean Plant Protein, Nourished By Nature" },
      { name: "twitter:description", content: "Premium plant-based protein crafted with clean ingredients. 24g protein, zero artificial flavours. Nothing artificial. Nothing hidden." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/10b63e26-ec7c-48c7-b4eb-6ab713da9bf8/id-preview-9f24777d--2a51671c-5b54-4bf1-b15c-dc3539e46f93.lovable.app-1782713854000.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/10b63e26-ec7c-48c7-b4eb-6ab713da9bf8/id-preview-9f24777d--2a51671c-5b54-4bf1-b15c-dc3539e46f93.lovable.app-1782713854000.png" },
    ],
    links: [
